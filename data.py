...
def process_data(data_path, file_path):
    ...
    masks = []
    for name in names:
        if os.path.isfile(os.path.join(data_path, f"images/{name}.jpg")):
            images.append(os.path.join(data_path, f"images/{name}.jpg"))
        if os.path.isfile(os.path.join(data_path, f"annotations/trimaps/{name}.png")):
            masks.append(os.path.join(data_path, f"annotations/trimaps/{name}.png"))
